...
return view.extend({
    ...
    render: function (load_result) {
        ...
        let asset_file_status = _('WARNING: at least one of asset files (geoip.dat, geosite.dat) is not found under /usr/share/xray. Xray may not work properly. Install <code>v2ray-geoip</code> and <code>v2ray-geosite</code> first, for example: <code>opkg update && opkg install v2ray-geoip v2ray-geosite</code>. See <a href="https://github.com/yichya/luci-app-xray">here</a> for help.');
        if (geoip_existence) {
